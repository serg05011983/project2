def filter_by_state(spisok_data_, state_ = "EXECUTED"):
...
def sort_by_date(spisok_data_, reverse_ = True):
    """Функция выполняет сортировку принимаемого списка словарей по дате """
    sorted_spisok = sorted(spisok_data_, key=lambda spisok_data_: spisok_data_['date'], reverse = reverse_)
